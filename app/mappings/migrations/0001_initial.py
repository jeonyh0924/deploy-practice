# Generated by Django 2.1.2 on 2018-12-05 09:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='screeningtime',
            name='screening',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='screening_times', to='mappings.Screening', verbose_name='상영'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='screening_time',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='selected_seats', to='mappings.ScreeningTime', verbose_name='상영시간'),
        ),
        migrations.AddField(
            model_name='reservedseat',
            name='seat',
        ...
        migrations.AddField(
            model_name='reservation',
            name='screening_time',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mappings.ScreeningTime', verbose_name='예매 시간'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='seat',
        ...
        migrations.AddField(
            model_name='reservation',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mappings', related_query_name='reservation', to=settings.AUTH_USER_MODEL, verbose_name='예매자'),
        ),
        migrations.AddField(
            model_name='cast',
            name='movie',
